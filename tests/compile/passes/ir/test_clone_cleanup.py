...
"""
Comprehensive tests for CloneCleanupPass.
...
def clone_cleanup_pass():
    return CloneCleanupPass(VllmConfig())
...
class TestCloneCleanup:
    """Test CloneCleanupPass behavior on various graph patterns."""
...
class TestCloneCleanupWithDonatedInputs:
    """Test CloneCleanupPass with donated input tracking via PassContext."""
